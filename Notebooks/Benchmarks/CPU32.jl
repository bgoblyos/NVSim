...
begin
	...
	const D = Float32(2870.292)
	const E = Float32(2.815312)
...
# ╔═╡ 0859882e-cef6-4269-8d0f-85f8243ae0a5
md"""
### CPU, Float32, single threaded
"""

# ╔═╡ a1f3cb98-29e8-4aa7-87ef-81415ec27c7d
@time CPU(500)

# ╔═╡ 97dbdefa-b3a9-44c7-aa0f-d3e16b646e85
@benchmark (CPU(x)) samples=10 seconds = 300 setup=(x = rand((10:500)))

# ╔═╡ 4058a571-3ade-4a58-b880-a8eb0e9b81bb
md"""
### CPU, Float32, multi-threaded
"""
