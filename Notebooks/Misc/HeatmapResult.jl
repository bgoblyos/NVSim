...
# ╔═╡ 0227154e-7431-11ef-3a60-cb4febf442b6
using Plots

# ╔═╡ e227dd60-5d8b-492e-93a5-918f05e7faf6
using Peaks

# ╔═╡ 4e579f91-21df-4721-82fc-4a17acdef387
using Measurements

# ╔═╡ 364e2d0b-dd78-4cf3-9bf6-c0c5e34f3570
using Unitful

# ╔═╡ be0ded7a-056b-464e-b60f-50e99d53a15f
using ImageFiltering

# ╔═╡ 6d54999d-f390-4ddf-a2c4-0579feafc74f
using NPZ
...
function movingAvg(data, n)
	m = 2n + 1
	kernel = OffsetArray(fill(1/m, m), -n:n)
	return imfilter(data, kernel)
end

# ╔═╡ 99d89ee1-943b-47e1-bca5-93f7b36235b1
function getODMRPeaks(freqs, signal)
	...
	for i in 1:8
		...
		newPks[i] = pks[peakIndex]
	end
	peaks = sort(peakFreqs)
	plt = plotpeaks(freqs, signal, peaks=newPks, prominences=false, widths=false, legend = false)
...
# ╔═╡ 9c24ccc9-5044-4b69-973c-24cf1387d659
savePeaks(95)
